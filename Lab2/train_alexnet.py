...
def plot_losses(train_losses, test_losses, save_path="loss_plots/training_loss_alexnet.png"):
    """
    ...
    plt.title('AlexNet Training and Validation Loss', fontsize=14)
...
def train_alexnet(num_epochs=50, batch_size=32, learning_rate=0.0001, 
    ...
    """
    print("=" * 60)
    print("AlexNet Transfer Learning - Training Script")
    print("=" * 60)
    ...
    model = AlexNetNose(pretrained=True)
...
def main():
    ...
    # Train the model
    model, train_losses, test_losses = train_alexnet(
